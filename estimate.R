...
# inputs
expr_data <- "~/Documents/TGL/TGL_support_project/TGL25/RNASEQ/Rcounts/RawCounts_Schwannomatosis_RNAseq.txt"
outdir <- "~/Documents/TGL/TGL_support_project/TGL25/RNASEQ"
ensFile <- "/Volumes/TGL/gsi/pipeline/data/TGL25/RNASEQ/ESTIMATE/ensGenes.txt"
gmtFile <- "~/Documents/TGL/TGL_support_project/TGL25/RNASEQ/ssGSEA/dahaner2017_liu2015_immune_genesets.gmt"
rodic <- "~/Documents/TGL/TGL_support_project/TGL25/RNASEQ/convert_rsem_to_zscore.r"
